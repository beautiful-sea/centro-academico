...
function slidebar() {
    ...
    c.fn.dropdownHover = function(l) {
        ...
        $(window).scroll(function() {
            i || (120 < $(window).scrollTop() && (n.addClass("shrink"), e.addClass("bd-scroll"), n.addClass("fixed-top")), $(window).scrollTop() < 121 && (null/*n.removeClass("shrink"), e.removeClass("bd-scroll"), n.removeClass("fixed-top")*/))
