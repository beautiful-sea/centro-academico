  ...
  ms-lead-navbar-white navbar-mode navbar-mode mb-0
    ">
      <div class="container container-full">
        ...
        <div class="collapse navbar-collapse" id="ms-navbar">
          <ul class="navbar-nav">
            <!-- Home -->
            <li class="nav-item dropdown dropdown-megamenu-container"><a data-scroll class="link" href="#home"> Home</a>
            </li>
            <li class="nav-item dropdown dropdown-megamenu-container"><a data-scroll class="link" href="#services">
                Serviços</a></li>
            <!-- Fotos -->
            <li class="nav-item dropdown dropdown-megamenu-container"><a data-scroll class="link" href="#portfolio">
                Fotos</a></li>
            <!-- Coordenadores -->
            <li class="nav-item dropdown dropdown-megamenu-container"><a data-scroll class="link" href="#team">
                Coordenadores</a></li>
            <!-- Engenharias -->
            <li class="nav-item dropdown">
              <a href="#" class="nav-link dropdown-toggle animated fadeIn animation-delay-8" data-toggle="dropdown"
              ...
              <ul class="dropdown-menu">
                ...
                <li><a target="_blank" class="dropdown-item" href="https://universidadedevassouras.edu.br/graduacao/engenhariacivil"><i
            ...
            <!-- Contato -->
            <li class="nav-item dropdown dropdown-megamenu-container"><a data-scroll class="link" href="#contact">
                Contato</a></li>
          </ul>
        </div>
        ...
        <div class="container">
          <div class="text-center mb-4">
            ...
            <p
             ...
             Esta pagina foi criada com o intuito, de mostrar um pouco mais das <span class="color-warning">nossas engenharias</span> para você discente ou ingresso dos cursos de engenharia.
            </p>
          </div>
    ...
    <div class="bg-light index-1 intro-fixed-next pt-6" id="intro-next">
      <div class="container mt-4">
        <h2 class="text-center color-bordo mb-2 wow fadeInDown animation-delay-4">Aqui você pode escolher algumas sub-paginas</h2>
        <p class="lead text-center aco wow fadeInDown animation-delay-5 mw-800 center-block mb-4"> No centro Academico, você pode conhecer um pouco de nosso CA, Na Atletica a nossa parte esportiva, Na Assembléia Geral um pouco das noticias de Reuniões e etc.
        <div class="row">
            <div class="col-md-4">
              <div class="card card-bordo">
                  <div class="card-header">
                    <h3 class="card-title"><i class="zmdi zmdi-graduation-cap"></i> Centro Acadêmico</h3>
                  </div>
                  ...
                  <div class="card-body overflow-hidden text-center">
                    <a href="centroacademico/index.html" class="btn btn-bordo btn-raised"><i class="zmdi  zmdi-play-for-work"></i> Entrar<div class="ripple-container"></div></a>
                  </div>
                </div>
              </div>
          <div class="col-md-4">
              <div class="card card-bordo">
                ...
                <div class="card-body overflow-hidden text-center">
                  <a href="atletica/index.php" class="btn btn-bordo btn-raised"><i class="zmdi  zmdi-play-for-work"></i> Entrar<div class="ripple-container"></div></a>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card card-bordo">
                ...
                <div class="card-body overflow-hidden text-center">
                   <a href="javascript:void(0)" class="btn btn-bordo btn-raised"><i class="zmdi  zmdi-play-for-work"></i> Entrar<div class="ripple-container"></div></a>
                </div>
              </div>
            </div>
        </div>
        ...
        <div class="wrap ms-hero-img-meeting ms-hero-bg-info color-white ms-bg-fixed">
          <div class="container">
            <div class="text-center mb-4">
              ...
              <h3 class="wow zoomInDown">Aqui deve ficar uma descrição <span class="text-normal"></span> 
              </h3>
            </div>
            <div class="row">
              <div class="col-lg-6">
                  ...
                  <div class="mb-0 card card-info wow fadeInUp animation-delay-2">
                    ...
                    <div id="collapseOne2" class="card-collapse collapse show" role="tabpanel"
                      ...
                      <div class="card-body color-dark">
                        <p>O objetivo do Curso é formar engenheiros eletricistas capacitados a atender às diferentes solicitações profissionais pertinentes, com uma visão crítica, criativa e inovadora, através de uma sólida formação básica, geral e humanística, associada à formação profissional específica, moderna e abrangente. Logo, o profissional egresso atenderá às necessidades do mercado de trabalho, compreendendo os seus problemas e identificando a metodologia mais adequada para a sua solução, levando sempre em conta as questões ambientais. Desta forma, o perfil do Curso, bem como o do profissional egresso, estão diretamente ligados às necessidades atualmente exigidas pelo mercado de trabalho.</p>
                        <p>Nosso curso possui  Nota 5 MEC 2018 numa escala de  (1 a 5) um curso de excelência em nossa região.	</p>
                      </div>
                    </div>
                  </div>
            ...
            <div class="mt-6 color-dark">
              ...
              <div class="text-center color-white mw-800 center-block mt-4">
                <p class="lead lead-lg wow fadeInUp animation-delay-2">Discover our projects and the rigorous process of
            ...
            <div class="col-lg-4 col-sm-6">
              <div class="card mt-4 card-success wow zoomInUp animation-delay-7">
                <div class="ms-hero-bg-success ms-hero-img-city">
                  <img src="{{asset('images/demo/avatar5.jpg')}}" alt="..." class="img-avatar-circle">
                </div>
                <div class="card-body pt-6 text-center">
            ...
            <div class="col-lg-4 col-sm-6">
              <div class="card mt-4 card-primary wow zoomInUp animation-delay-7">
                <div class="ms-hero-bg-primary ms-hero-img-city">
                  <img src="{{asset('images/demo/avatar6.jpg')}}" alt="..." class="img-avatar-circle">
                </div>
                <div class="card-body pt-6 text-center">
