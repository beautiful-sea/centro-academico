                            ...
                            <div class="intro-fixed-content index-1">
                                <div class="container">
                                    <div class="text-center mb-4">
                                        ...
                                        class="color-warning">nossas engenharias</span> para você discente ou ingressante dos
                    ...
                    <div class="bg-light index-1 intro-fixed-next pt-6" id="intro-next">
                        <div class="container mt-4">
                            ...
                            <p class="lead text-center aco wow fadeInDown animation-delay-5 mw-800 center-block mb-4"> No centro
                                Academico, você pode conhecer um pouco de nosso CA, Na Atletica a nossa parte esportiva.
                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        ...
                                                        <p class="wow fadeInUp animation-delay-3">
                                                            ...
                                                            ingressante ou discente dos cursos de engenharia. Ao lado você pode encontrar uma breve descriçao sobre cada curso e sua respectivas notas na classificaçao do MEC. Atualmente nossa
